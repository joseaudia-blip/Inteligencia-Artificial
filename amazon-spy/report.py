...
<title>🆕 Nuevos en Amazon Panamá — {date_str}</title></head>
  ...
  <tr><td>
    ...
    <table cellpadding="0" cellspacing="0" width="100%"
      ...
      <tr><td style="padding:28px 24px;text-align:center;">
        <div style="font-size:1.4rem;font-weight:800;color:#fff;letter-spacing:-.5px;">
          🆕 Nuevos en Amazon — Panamá
        </div>
        <div style="font-size:.85rem;color:#94a3b8;margin-top:6px;">
          🗓️ {date_str} · ⏰ 06:00 AM · New Releases — productos nuevos que están despegando
        </div>
    ...
    <table cellpadding="0" cellspacing="0" width="100%"
      ...
      <tr><td style="padding:14px;text-align:center;font-size:.72rem;color:#9ca3af;">
        Generado automáticamente · Amazon USA New Releases · {date_str}<br>
...
<title>🆕 Nuevos en Amazon Panamá — {date_str}</title>
...
<!-- HEADER -->
<div class="header">
  <h1>🆕 Nuevos en Amazon — Panamá</h1>
  <div class="header-sub">🗓️ {date_str} · ⏰ {time_str} · New Releases — productos nuevos que están despegando</div>
...
<div class="footer">
  Generado automáticamente · Amazon USA New Releases · {date_str}
</div>
